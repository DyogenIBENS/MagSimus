...
__doc__ = """
        Compare two genomes using ancGenes families
                - Draw Matrix
                - Draw Karyotype
"""
import enum
...
import utils.myPsOutput as myPsOutput
import utils.myKaryoDrawer as myKaryoDrawer
...
modes = enum.Enum("svgItemsMatrixFromRawData", "drawKaryotype", "printOrthologuesList", "printOrthologuesCount", "printGeneDiff", "printOrthologousChrom")
...
arguments = myTools.checkArgs(
        ...
        ("reverse",bool,False),
        ("mode",modes,"svgItemsMatrixFromRawData"),
...
def drawMatrix():
    ...
    myPsOutput.drawText(4, 0.3, arguments["referenceGenome"] if arguments["reverse"] else arguments["studiedGenome"], arguments["matrix:penColor"])
    print "90 rotate"
    myPsOutput.drawText(4, -0.5, arguments["studiedGenome"] if arguments["reverse"] else arguments["referenceGenome"], arguments["matrix:penColor"])
    print "-90 rotate"
